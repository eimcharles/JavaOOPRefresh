...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // The use of super.sayHi() - calls parent method
        String johnsLanguagesFromParent = john.writeSomeCodeFromParent();
        System.out.println(johnsLanguagesFromParent);
        System.out.println(john);
        System.out.println();

        // The use of protected sayHi() - calls overridden method
        String johnsLanguages = john.writeSomeCodeFromChild();
        System.out.println(johnsLanguages);
        System.out.println();

        // We extend Employee with Programmer, the child class has access to all the parent methods
        System.out.println(john.getName());
        System.out.println(john.getAge());
        System.out.println(john.getAddress());
        System.out.println();

        // Manager inherits name, address and employee attributes from parent - initializes teamSize
        ...
        // We extend Employee with Manager, the child class has access to all the parent methods
